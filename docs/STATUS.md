...
components/
  ...
  screens/                 portal (compone marketing), portal-hero (cortina+canvas+box IA),
                           **home-wizard (wizard embebido)**, **onboarding (vórtice 3 pasos → wizard)**, **subscription-modal (paywall de créditos)**, **user-dashboard / account-view / project-view (directorio)**,
