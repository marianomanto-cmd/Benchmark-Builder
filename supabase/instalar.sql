...
-- ═══ 20260101000500_items_check.sql ═══
...
-- ═══ 20260101000600_vigencia_por_fecha.sql ═══
...
-- ═══ 20260101000700_guardas_en_la_base.sql ═══
...
-- ═══ 20260101000800_duplicar_fiel.sql ═══
...
-- ═══ 20260101000900_reloj_sin_respuesta.sql ═══
...
-- ═══ 20260101001000_paridad_redondeo.sql ═══
...
-- ═══ 20260101001100_alta_historial.sql ═══
...
-- ═══ 20260101001200_aumento_exacto.sql ═══
...
-- ═══ 20260101001300_duplicado_afiliado.sql ═══

-- ════════════════════════════════════════════════════════════════════
-- Smile Lab · Presupuestos — 14 · Coherencia del duplicado y del conteo
--
-- 1. El duplicado tomaba la obra social del presupuesto ORIGINAL pero
--    el número de afiliado de la ficha ACTUAL del paciente. Si el
--    paciente cambió de obra social entre medio, el documento nuevo
--    salía con «OSDE 210» y un número de afiliado de Apross. El
--    afiliado sólo se refresca cuando la ficha sigue en la misma obra
--    social que el presupuesto.
--
-- 2. El «Histórico completo» de la pantalla 10 contaba los usos
--    trayéndose `presupuesto_items` entero. PostgREST corta en
--    `max_rows` (1000 por defecto): pasado ese punto los conteos
--    empiezan a mentir hacia abajo, y de ese conteo depende el sello
--    «no editable» de una vigencia. Se resuelve con una vista agregada,
--    que devuelve una fila por arancel en vez de una por ítem.
--
-- 3. La última cuota absorbe el redondeo con una resta. Con los
--    porcentajes validados no puede dar negativo, pero un negativo
--    abortaría la emisión entera contra el check de la tabla: se le
--    pone piso en 0 por las dudas.
-- ════════════════════════════════════════════════════════════════════
